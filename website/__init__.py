...
def initialize_database():
    ...
    insert_game('Super Mario 64',date_time,'supermario64.png',8)
    insert_game('Portal',date_time,'portal.png',1)
    insert_game('Seterra',date_time,'seterra.png',2)
    insert_game('Ultrakill',date_time,'ultrakill.png',4)
    insert_game('Celeste',date_time,'celeste.png',5)
    insert_game('Zelda: Breath of the Wild',date_time,'botw.png',6)
    insert_game('Super Mario Galaxy 2',date_time,'img3.png',7)
    insert_game('Example 0',date_time,'img3.png',9)
    insert_game('Example 1',date_time,'img3.png',10)
    insert_game('Example 2',date_time,'img3.png',11)
    insert_game('Example 3',date_time,'img3.png',11)
    insert_game('Example 4',date_time,'img3.png',11)
    insert_game('Example 5',date_time,'img3.png',11)
    insert_game('Example 6',date_time,'img3.png',11)
    insert_game('Example 7',date_time,'img3.png',11)
    insert_game('Example 8',date_time,'img3.png',11)
    insert_game('Example 9',date_time,'img3.png',11)
    insert_game('Example 10',date_time,'img3.png',11)
    insert_game('Example 11',date_time,'img3.png',11)
    insert_game('Example 12',date_time,'img3.png',11)
    insert_game('Example 13',date_time,'img3.png',11)
    insert_game('Example 14',date_time,'img3.png',11)
    insert_game('Example 15',date_time,'img3.png',11)
    insert_game('Example 16',date_time,'img3.png',11)
    insert_game('Example 17',date_time,'img3.png',11)
    insert_game('Example 18',date_time,'img3.png',11)
    insert_game('Example 19',date_time,'img3.png',11)
    insert_game('Example 20',date_time,'img3.png',11)
    insert_game('Example 21',date_time,'img3.png',11)
    ...
    insert_record('dustforce any% tutorial WR','current world record in the tutorial level',date_time,'iHoJfi4jXIQ',0,1,15,100,1,1,5,'')
    insert_record('dustforce any%','run for the game',date_time,'LkCUxnXEZ9I',1,2,45,33,2,1,1,'')
