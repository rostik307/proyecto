...
def initialize_database():
    ...
    insert_game('Example 2',date_time,'img2.png',2)
    insert_game('Example 3',date_time,'img2.png',4)
    insert_game('Example 4',date_time,'img2.png',5)
    insert_game('Example 5',date_time,'img2.png',6)
    insert_game('Example 6',date_time,'img2.png',7)
    insert_game('Example 7',date_time,'img2.png',9)
    insert_game('Example 8',date_time,'img2.png',10)
    insert_game('Example 9',date_time,'img2.png',11)
